        ...
        <template v-for="item in items">
          ...
          >
            ...
            <v-list-item v-for="(child, i) in item.children" :key="i" link>
              ...
              <v-list-item-content class="ml-7" v-else>
                <v-list-item-title class="grey--text text--lighten-2 d-flex justify-space-between">
...
export default {
  ...
  methods: {
    ...
    goToStudy(no) {
      if (this.$route.params.id == no) return;
